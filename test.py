...
# hyper-parameters
# ------------
# imdb_name options: 'voc_2007_test', 'voc_2012_test', 'voc_0712_test'
# 'voc_0712_test' DOES NOT work now.
imdb_name = 'voc_2007_test'
cfg_file = 'experiments/cfgs/faster_rcnn_end2end.yml'
# trained_model = '/media/longc/Data/models/VGGnet_fast_rcnn_iter_70000.h5'
#trained_model = 'models/saved_model3/faster_rcnn_resnet101_60000.h5'
trained_model = 'models/saved_model3/faster_rcnn_vgg16_80000.h5'

rand_seed = 1024

save_name = 'faster_rcnn_resnet101_60000'
max_per_image = 300
thresh = 0.05
vis = True
...
def test_net(name, net, imdb, max_per_image=300, thresh=0.05, vis=False):
    ...
    for i in range(num_images):
        ...
        for j in xrange(1, imdb.num_classes):
            ...
            kk = int(j > 0)
            cls_boxes = boxes[inds, kk * 4:(kk + 1) * 4]
        ...
        if vis:
            cv2.imwrite('./test_out/test_' + str(i) + '.jpg', im2show)
...
if __name__ == '__main__':
    ...
    net = LH_RCNN(classes=imdb.classes, debug=False)
