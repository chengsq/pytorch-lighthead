...
from pycocotools.coco import COCO			# Fixed version
from pycocotools.cocoeval import COCOeval	# Fixed version
from pycocotools import mask as COCOmask	# Fixed version
